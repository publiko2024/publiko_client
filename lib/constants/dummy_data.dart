...
여러분의 소중한 의견을 기다리고 있습니다. 함께 힘을 모아 우리의 삶을 더 나은 방향으로 변화시켜 봅시다!''',
  ...
  Post(
    ...
    content: '''장애인의 이동권을 보장하기 위한 정책이나 제도에 대해 여러분의 의견을 듣고 싶습니다.\n
현재의 제도가 얼마나 효과적이라고 생각하시나요?\n\n
...
제도 개선을 위해 어떤 추가적인 조치가 필요할까요?''',
  ...
  Post(
    ...
    nickname: '아롱사태',
    title: '장애인 직업훈련 후기',
    content: '''최근에 장애인 직업훈련 프로그램에 참여해 보았습니다.

이 프로그램은 저에게 정말 많은 도움이 되었어요. 특히 직무 교육뿐만 아니라, 직장 내에서의 장애인 지원 정책에 대해서도 많은 정보를 얻을 수 있었습니다. 전문가의 상담과 실제 직무 체험이 정말 유익했습니다.
